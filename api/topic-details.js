...
const topicDetailRouter = require('../backend/routes/topicDetail').default || require('../backend/routes/topicDetail');

const BASE = '/api/topic-details';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Serverless wrapper error (topic-details)', e);
