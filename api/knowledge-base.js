...
const kbRouter = require('../backend/routes/knowledgeBase').default || require('../backend/routes/knowledgeBase');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Serverless wrapper error (knowledge-base)', e);
