...
const researchRouter = require('../backend/routes/researchAreas').default || require('../backend/routes/researchAreas');

const BASE = '/api/research-areas';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Serverless wrapper error (research-areas)', e);
