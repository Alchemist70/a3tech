...
const WaecQuestionSchema = new mongoose.Schema({
  subject: { type: String, required: true }, // e.g., "English Language", "Mathematics", "Physics", etc.
...
WaecQuestionSchema.index({ subject: 1, isActive: 1 });

module.exports = mongoose.model('WaecQuestion', WaecQuestionSchema);
